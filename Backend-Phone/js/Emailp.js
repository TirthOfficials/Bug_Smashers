 ...
 //document.addEventListener('click',sendmail())
  ...
  function sendmail(){
    ...
    var mess= 'Hello,<br><br>Specifications about your product have been submitted successfully.<br>You will receive a security deposit of Rs. 5000 for the Phone.<br><br>Within a few days, our employee will visit the address you have submitted to check the product and accordingly, you will be provided with the actual price for that product.<br><br>Thank you for trusting Electro-trade. If you liked our services, do recommend it to your friends and family.'
